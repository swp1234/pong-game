...
2026-09-03 시작된 무효 트래픽 검토 동안 광고 로더, 수동 광고, 전면 광고와 보상형 점수 기능을 사용하지 않습니다.

## Google Analytics 4

추적 ID: `G-J8GSWM40TV`

제품 이벤트는 `pong_view → pong_start → pong_complete → pong_share/pong_related_click` 단계만 전송합니다. 모드, 점수, 승패, 시간과 공유 URL은 전송하지 않습니다.
